...
public class HumanNameGenerator implements NameGenerator {
    ...
    // 姓
    private static final String[] firstNames = {GdxText.val("李"),
            GdxText.val("王"),
            GdxText.val("张"),
            GdxText.val("刘"),
            GdxText.val("陈"),
    ...
    // 女名
    private static final String[] femaleLastNames = {GdxText.val("梦琪"),
            GdxText.val("忆柳"),
            GdxText.val("之桃"),
            GdxText.val("慕青"),
            GdxText.val("问兰"),
    ...
    // 男名
    private static final String[] maleLastNames = {GdxText.val("华"),
            GdxText.val("伟"),
            GdxText.val("强"),
            GdxText.val("磊"),
            GdxText.val("军"),
