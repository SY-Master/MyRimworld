...
- 生物：所有种族都属于生物
  - 人类：人类会根据一些策略自动活动。人类和人类之间会存在互动，每次互动根据互动类型增加或减少双方好感度。
    - 普通人：加入了势力的人类。
    - 野人：没有加入任何势力的人类。
    - 玩家操控人类：和普通人类差不多，但是玩家可以操控。游戏开始时会有几个默认的人类，玩家也可以通过一些手段招募其他人类。
...
- 命令：玩家的人类会根据命令发起顺序执行相应的命令。
  - 控制人类状态：当有控制人类时操作模式会改变，而且会根据控制人类的数量来使用不同的模式。
    - 单人控制：只控制一个人类的情况下会变成单人控制。
    - 多人控制：控制多个人的情况下变成多人控制。
